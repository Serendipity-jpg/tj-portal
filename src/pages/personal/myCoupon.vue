...
<template>
  <div class="couponWrapper">
    <div class="personalCards">
      <div class="headTop fx-sb">
        ...
        <div class="fx">
          ...
          <span @click="() => $router.push({path: '/personal/main/myCouponExplain'})" class="font-bt ft-14">优惠券使用说明&gt;</span>
        </div>
      </div>
      <div>
    ...
    <el-dialog
      ...
      width="30%"
    >
      <div class="exchangeCoupon fx"><span>优惠券码：</span><el-input type="text" v-model="inputVal" placeholder="请输入" /></div>
      <template #footer>
...
import { getMyCoupon, exchangeCoupon } from "@/api/class.js";
